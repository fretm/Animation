window.onload = function () {
    ...
    let animationTemplate = `<div id ="geolocation_id"></div> 
                             <textarea  id="textAreaId" cols="70%" rows="15%" disabled></textarea><br><br>
                             <button class="btn btn-primary" id="animation_id"> Refresh Animation </button>
                             <button class="btn btn-primary" id="logout_id"> LogOut </button> `
